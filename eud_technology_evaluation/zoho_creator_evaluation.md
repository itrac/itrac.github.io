...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 1 | How much technical experience is necessary in order to perform integrations? | Average | The platform provide a drag and drop functionality, but is necessary identify what are protocols and how are done the communication with Web Services |
...
| 4 | Which tools can be integrated? | Zoho apps, paypal services, Google apps, QuickBooks | List available in site of Zoho |
| 5 | What are the integration methods supported by the platform? | Software Service  |  |
...
| 7 | Exists documentation, messages, or notifications that explains about developed application's security? | No |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 8 | The platform notify when it has updates? | Not applicable |  |
| 9 | Is it possible to configure automatic updates? | Not applicable |  |
