...
1. Which features does the platform have?
	...
	**A**: The OutSystems platform allows to create web and mobile applications by developing processes, conditions, data, layouts, and actions using an intuitive GUI. OutSystems contains a library with more than 100 base graphical interfaces to mobile and web applications in the SILK UI standard. At the stages of deploy and maintenance of the developed application, OutSystems contains a deploy control tool.
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 1 | Is it possible to share components with other collaborators? | Yes | Using the Forge - OutSystems community library, or in a development team library |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 2 | Each collaborator can coordinate yourself? | Yes | It is possible to create a sandbox to develop features, but the platform does not have an activity manager feature |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 8 | Are there ways to search for other collaborators? | No |  |
| 9 | Does it allow communication between collaborators? | No |  |
...
| 1.5 | In multipage data entry screens, is each page labeled to show its relation to others? | No |  |
...
| 1.9 | After the user completes an action (or group of actions), does the feedback indicate that the next group of actions can be started? | Yes |  |
...
| 2.3 | Do related and interdependent fields appear on the same screen? | No |  |
...
| 3.7 | Is there an "undo" function at the level of a single action, a data entry, and a complete group of actions? | Yes |  |
| 3.8 | Can users cancel out of operations in progress? | Yes |  |
...
| 4.6 | Are vertical and horizontal scrolling possible in every screen? | No |  |
...
| 4.14 | Are fields and labels left-justified for alpha lists and right-justified for numeric lists? | Yes |  |
...
| 5.16 | If the system supports both novice and expert users, are multiple levels of error-message detail available? | Yes |  |
...
| 7.3 | Are all data a user needs on display at each step in a transaction sequence? | No |  |
...
| 7.23 | Are there menu selection defaults? | Yes |  |
| 7.24 | Do GUI menus offer affordance: that is, make obvious where selection is possible? | No |  |
| 7.25 | Do data entry screens and dialog boxes indicate when fields are optional? | No |  |
...
| 8.2 | Does the system provide function keys or shortcuts for high-frequency commands? | Yes |  |
...
| 11.9 | Is the method for moving the cursor to the next or previous field both simple and visible? | No |  |
| 11.10 | Has auto-tabbing been avoided except when fields have fixed lengths or users are experienced? | Yes |  |
| 11.11 | Are function keys or keyboard shortcuts reserved for generic, high-frequency, important functions? | Yes |  |
...
| 15.5 | Currency conversions and formats are handled properly | No |  |
| 15.6 | Terminology is consistent across the UI, help files and documentation | No |  |
| 15.7 | Text is free of grammatical mistakes | Not applicable |  |
| 15.8 | Text is properly translated | Not applicable |  |
| 15.9 | Text is free of character corruption | Yes |  |
| 15.10 | Line breaks and hyphenation are correct | Not applicable |  |
