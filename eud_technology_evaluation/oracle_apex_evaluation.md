...
| 3 | What are the integration methods supported by the platform? | List of integrations methods supported / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 6 | The platform notify when it has updates? | Yes / No |  |
| 7 | Is it possible to configure automatic updates? | Yes / No / Not applicable |  |

### File Upload Security

| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 8 | If the platform accepts file upload, is it check file type and size? | Yes / No / Not Applicable |  |
| 9 | If the platform accepts file upload, is it check if the content match with file type? | Yes / No / Not Applicable |  |

### Report Behaviors

| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 10 | Is it possible to select which information will be sent in a report message? | Yes / No / Not applicable |  |

### Developed Application Security

| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 11 | Is it possible to analyze vulnerabilities of the developed application inside the platform? | Yes / No |  |
| 12 | Exists documentation, messages, or notifications that explains about developed application's security? | Yes / No |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 2.1 | Are icons concrete and familiar? | Yes / No / Not applicable |  |
| 2.2 | If there is a natural sequence to menu choices, has it been used? | Yes / No / Not applicable |  |
| 2.3 | Do related and interdependent fields appear on the same screen? | Yes / No / Not applicable |  |
| 2.4 | Do the selected colors correspond to common expectations about color codes? | Yes / No / Not applicable |  |
| 2.5 | When prompts imply a necessary action, are the words in the message consistent with that action? | Yes / No / Not applicable |  |
| 2.6 | On data entry screens, are tasks described in terminology familiar to users? | Yes / No / Not applicable |  |
| 2.7 | Do menu choices fit logically into categories that have readily understood meanings? | Yes / No / Not applicable |  |
| 2.8 | Do the command and information language employ user jargon and avoid computer jargon? | Yes / No / Not applicable |  |
| 2.9 | Are command names specific rather than general? | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 3.1 | If setting up tabs is a low-frequency task, is it particularly easy to remember? | Yes / No / Not applicable |  |
| 3.2 | In systems that use overlapping tabs, is it easy for users to rearrange tabs on the screen? | Yes / No / Not applicable |  |
| 3.3 | In systems that use overlapping tabs, is it easy for users to switch between tabs? | Yes / No / Not applicable |  |
| 3.4 | When a user's task is complete, does the system wait for a signal from the user before processing? | Yes / No / Not applicable |  |
| 3.5 | Can users type-ahead or use mnemonic code in a system with many nested menus? | Yes / No / Not applicable |  |
| 3.6 | Are users prompted to confirm commands that have drastic, destructive consequences? | Yes / No / Not applicable |  |
| 3.7 | Is there an "undo" function at the level of a single action, a data entry, and a complete group of actions? | Yes / No / Not applicable |  |
| 3.8 | Can users cancel out of operations in progress? | Yes / No / Not applicable |  |
| 3.9 | Can users reduce data entry time by copying and modifying existing data? | Yes / No / Not applicable |  |
| 3.10 | Are character edits allowed in data entry fields? | Yes / No / Not applicable |  |
| 3.11 | If menu lists are long (more than seven items), can users select an item using type-ahead, moving the cursor, or by typing a mnemonic code? | Yes / No / Not applicable |  |
| 3.12 | Are menus broad (many items on a menu) rather than deep (many menu levels)? | Yes / No / Not applicable |  |
| 3.13 | If the system has multiple menu levels, is there a mechanism that allows users to go back to previous menus? | Yes / No / Not applicable |  |
| 3.14 | If users can go back to a previous menu, can they change their earlier menu choice? | Yes / No / Not applicable |  |
| 3.15 | Can users move forward and backward between fields or dialog box options? | Yes / No / Not applicable |  |
| 3.16 | If the system has multipage data entry screens, can users move backward and forward among all the pages in the set? | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 8.1 | Does the system allow novice users to enter the simplest, most common form of each command, and allow expert users to add parameters? | Yes / No / Not applicable |  |
| 8.2 | Does the system provide function keys or shortcuts for high-frequency commands? | Yes / No / Not applicable |  |
| 8.3 | For data entry screens with many fields or in which source documents may be incomplete, can users save a partially filled screen? | Yes / No / Not applicable |  |
| 8.4 | Does the system automatically enter leading zeros? | Yes / No / Not applicable |  |
| 8.5 | Does the system offer "find next" and "find previous" shortcuts for database searches? | Yes / No / Not applicable |  |
| 8.6 | On data entry screens, do users have the option of either clicking directly on a field or using a keyboard shortcut? | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 9.1 | Is only (and all) information essential to decision making displayed on the screen? | Yes / No / Not applicable |  |
| 9.2 | Are all icons in a set visually and conceptually distinct? | Yes / No / Not applicable |  |
| 9.3 | Does each icon stand out from its background? | Yes / No / Not applicable |  |
| 9.4 | If the system uses a standard GUI interface where menu sequence has already been specified, do menus adhere to the specification whenever possible? | Yes / No / Not applicable |  |
| 9.5 | Are meaningful groups of items separated by white space, border or color background? | Yes / No / Not applicable |  |
| 9.6 | Does each data entry screen have a short, simple, clear, distinctive title? | Yes / No / Not applicable |  |
| 9.7 | Are field labels brief, familiar, and descriptive? | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 10.1 | If users are working from hard copy, are the parts of the hard copy that go on-line marked? | Yes / No / Not applicable |  |
| 10.2 | Are on-line instructions visually distinct? | Yes / No / Not applicable |  |
| 10.3 | Do the instructions follow the sequence of user actions? | Yes / No / Not applicable |  |
| 10.4 | If menu choices are ambiguous, does the system provide additional explanatory information when an item is selected? | Yes / No / Not applicable |  |
| 10.5 | If menu items are ambiguous, does the system provide additional explanatory information when an item is selected? | Yes / No / Not applicable |  |
| 10.6 | Is the help function visible; for example, a key labeled HELP or a special menu? | Yes / No / Not applicable |  |
| 10.7 | Navigation: Is information easy to find? | Yes / No / Not applicable |  |
| 10.8 | Presentation: Is the visual layout well designed? | Yes / No / Not applicable |  |
| 10.9 | Conversation: Is the information accurate, complete, and understandable? | Yes / No / Not applicable |  |
| 10.10 | Goal-oriented (What can I do with this program?) | Yes / No / Not applicable |  |
| 10.11 | Descriptive (What is this thing for?) | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 13.1 | Are protected areas completely inaccessible? | Yes / No / Not applicable |  |
| 13.2 | Can protected or confidential areas be accessed with certain passwords. | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 14.1 | All non-text content that is presented to the user has a text alternative that serves the equivalent purpose. | Yes / No / Not applicable |  |
| 14.2 | Color is not used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element.  | Yes / No / Not applicable |  |
| 14.3 | All functionality of the content is operable through a keyboard interface without requiring specific timings for individual keystrokes.  | Yes / No / Not applicable |  |
| 14.4 | If keyboard focus can be moved to a component using a keyboard interface, then focus can be moved away from that component using only a keyboard interface, and, if it requires more than unmodified arrow or tab keys or other standard exit methods, the user is advised of the method for moving focus away. | Yes / No / Not applicable |  |
| 14.5 | If content can be navigated sequentially and the navigation sequences affect meaning or operation, focusable components receive focus in an order that preserves meaning and operability.  | Yes / No / Not applicable |  |
| 14.6 | The purpose of each link can be determined from the link text alone | Yes / No / Not applicable |  |
| 14.7 | More than one way is available to locate an item in a set of items, whether it is a Web page within a set of Web pages, a document within a set of non-web documents, or a program within a set of software programs.  | Yes / No / Not applicable |  |
| 14.8 | Any keyboard operable user interface has a mode of operation where the keyboard focus indicator is visible.  | Yes / No / Not applicable |  |
| 14.9 | When any component receives focus, it does not initiate a change of context. | Yes / No / Not applicable |  |
...
| ID | Question | Answer | Observations |
|:---|:----------------------------------------------------|:------------------|:------------------|
| 15.1 | Glossaries are available for reference and consistency check | Yes / No / Not applicable |  |
| 15.2 | Previously translated products are available for reference | Yes / No / Not applicable |  |
| 15.3 | Date and time is properly formatted for target region | Yes / No / Not applicable |  |
| 15.4 | Colors are appropriate for the target market and express the desired message | Yes / No / Not applicable |  |
| 15.5 | Currency conversions and formats are handled properly | Yes / No / Not applicable |  |
| 15.6 | Terminology is consistent across the UI, help files and documentation | Yes / No / Not applicable |  |
| 15.7 | Text is free of grammatical mistakes | Yes / No / Not applicable |  |
| 15.8 | Text is properly translated | Yes / No / Not applicable |  |
| 15.9 | Text is free of character corruption | Yes / No / Not applicable |  |
| 15.10 | Line breaks and hyphenation are correct | Yes / No / Not applicable |  |
