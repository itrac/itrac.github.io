...
| 1.4 | Do menu instructions, prompts, and error messages appear in the same place(s) on each menu? | No |  |
...
| 1.8 | Is there some form of system feedback for every operator action? | No |  |
